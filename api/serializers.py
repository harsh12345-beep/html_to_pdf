...
class PDFDataSerializer(serializers.Serializer):
    ...
    investigation = serializers.CharField(max_length=255)
    advice = serializers.CharField(max_length=255)
    chief_complaints = serializers.CharField(max_length=255)
    examination_findings = serializers.CharField(max_length=255)
    diagnosis = serializers.CharField(max_length=255)
    treatment_plan = serializers.CharField(max_length=255)
    medications = serializers.CharField(max_length=255)
